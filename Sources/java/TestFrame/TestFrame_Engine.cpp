...
JNIEXPORT jint JNICALL Java_TestFrame_Engine_ReportCheck(JNIEnv* pEnv, jclass cl, jstring strDescription, jstring strExpected, jstring strRecorded, jint nCheckResult)
{
	// Convert Java strings to char pointers
